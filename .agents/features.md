...
1. `k6 x docs` with no args: shows the TOC (TTY glamour-rendered, non-TTY plain markdown)
...
13. Non-TTY stdout → plain markdown (TOC, topic lookups, and search all served as content)
